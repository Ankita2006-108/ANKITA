        ...
        <section className="relative overflow-hidden rounded-xl bg-dark-card pt-20 pb-16 px-8 md:px-16 border border-dark-border shadow-2xl">
           ...
           <div className="relative z-10 max-w-3xl">
              ...
              <div className="flex flex-wrap gap-6">
                 <button className="bg-accent-green text-black px-10 py-4 rounded-sm text-[11px] font-bold uppercase tracking-[0.3em] hover:brightness-110 transition-all shadow-xl shadow-accent-green/5">
                    Launch Simulator
                 </button>
