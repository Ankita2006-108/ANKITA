...
export const NanobotExpert: React.FC = () => {
  const [messages, setMessages] = useState<{ role: 'user' | 'bot'; content: string }[]>([
    { role: 'bot', content: "Hello! I'm your NanoSynth Expert. Ask me anything about the green synthesis of silver nanoparticles, phytochemistry, or nanotechnology applications." }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      const response = await ai.models.generateContent({
        ...
        config: {
          systemInstruction: "You are an expert scientist specializing in Nanotechnology and Green Synthesis. Provide detailed, accurate, and scientific information about Silver Nanoparticles (AgNPs). Focus on plant-based reduction, characterization techniques (UV-Vis, TEM, XRD), and eco-friendly laboratory protocols. Keep responses helpful and professional."
        }
      });
